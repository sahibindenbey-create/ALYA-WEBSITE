    ...
    <div className="alya-gallery">
      <div className="alya-gallery-layout">
        ...
        <div className="alya-gallery-main">
          ...
          <div className="alya-product-image" onClick={openLightbox} onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} role="button" tabIndex={0} onKeyDown={event => { if (event.key === 'Enter' || event.key === ' ') { event.preventDefault(); openLightbox(); } }} aria-label="Fotoğrafı tam ekran aç">
      ...
      <style jsx>{`
        .alya-gallery{width:100%;min-width:0;overflow:visible}.alya-gallery-layout{display:grid;grid-template-columns:72px minmax(0,1fr);gap:14px;align-items:start;width:100%;min-width:0}.alya-gallery-thumbnails{display:flex;flex-direction:column;gap:8px;max-height:none;overflow:visible;padding:0}.alya-gallery-thumb{width:72px;height:86px;flex:none;border:0;background:transparent;padding:0;overflow:hidden;cursor:pointer;transition:opacity .2s ease}.alya-gallery-thumb.is-active{opacity:1}.alya-gallery-thumb:not(.is-active){opacity:.58}.alya-gallery-thumb:hover{opacity:1}.alya-gallery-thumb img{width:100%;height:100%;object-fit:contain;display:block;transition:transform .3s ease}.alya-gallery-thumb:hover img{transform:scale(1.04)}.alya-gallery-main{min-width:0;width:100%;display:flex;flex-direction:column}.alya-product-image{position:relative;background:transparent;width:100%;min-height:560px;height:auto;display:flex;align-items:center;justify-content:center;overflow:visible;touch-action:pan-y;cursor:zoom-in;outline:none}.alya-product-image img{display:block;width:auto;height:auto;max-width:100%;max-height:760px;object-fit:contain;object-position:center;padding:0;box-sizing:border-box;transition:transform .35s ease}.alya-product-image:hover img{transform:scale(1.015)}.alya-gallery-expand{position:absolute;right:10px;top:10px;width:38px;height:38px;border:0;background:rgba(255,255,255,.88);display:grid;place-items:center;z-index:3;cursor:pointer;color:#171717}.alya-gallery-expand:hover{background:#171717;color:#fff}.alya-gallery-arrow{position:absolute;top:50%;transform:translateY(-50%);width:42px;height:42px;border:0;background:rgba(255,255,255,.9);display:grid;place-items:center;z-index:3;cursor:pointer;color:#171717}.alya-gallery-arrow:hover{background:#171717;color:#fff}.alya-gallery-prev{left:10px}.alya-gallery-next{right:10px}.alya-gallery-counter{position:absolute;right:10px;bottom:10px;background:rgba(255,255,255,.9);padding:7px 10px;font-size:10px;letter-spacing:1px;color:#171717}.alya-gallery-caption{display:flex;justify-content:space-between;gap:16px;padding:11px 0 0;font-size:10px;letter-spacing:.2px;color:#777}.alya-gallery-caption span:last-child{color:#aaa}.alya-image-fallback{display:grid;place-items:center;text-align:center;color:#777;padding:30px}.alya-image-fallback span{font-size:30px;font-weight:800;letter-spacing:-2px}.alya-image-fallback small{margin-top:8px;font-size:11px}.alya-gallery-lightbox{position:fixed;inset:0;background:rgba(15,15,15,.96);display:flex;align-items:center;justify-content:center;padding:24px;z-index:9999;cursor:zoom-out}.alya-gallery-lightbox img{display:block;max-width:96vw;max-height:92vh;width:auto;height:auto;object-fit:contain;cursor:default}.alya-lightbox-close{position:absolute;right:24px;top:18px;width:44px;height:44px;border:1px solid rgba(255,255,255,.25);background:rgba(0,0,0,.18);color:#fff;display:grid;place-items:center;cursor:pointer;z-index:4}.alya-lightbox-close:hover{background:#fff;color:#171717}.alya-lightbox-arrow{position:absolute;top:50%;transform:translateY(-50%);width:58px;height:58px;border:0;background:rgba(0,0,0,.2);backdrop-filter:blur(8px);color:#fff;display:grid;place-items:center;cursor:pointer;z-index:4}.alya-lightbox-arrow:hover{background:#fff;color:#171717}.alya-lightbox-prev{left:28px}.alya-lightbox-next{right:28px}.alya-lightbox-counter{position:absolute;left:50%;bottom:25px;transform:translateX(-50%);color:#fff;font-size:11px;letter-spacing:2px;background:rgba(0,0,0,.25);padding:8px 12px;z-index:4}@media(max-width:900px){.alya-gallery-layout{display:flex;flex-direction:column;gap:10px}.alya-gallery-main{width:100%;order:1}.alya-gallery-thumbnails{order:2;flex-direction:row;width:100%;max-height:none;overflow-x:auto;overflow-y:hidden;padding:0 0 4px;scrollbar-width:none}.alya-gallery-thumbnails::-webkit-scrollbar{display:none}.alya-gallery-thumb{width:76px;height:92px}.alya-product-image{min-height:0;max-height:none}.alya-product-image img{max-width:100%;max-height:78vh}.alya-gallery-arrow{width:44px;height:44px}.alya-gallery-prev{left:8px}.alya-gallery-next{right:8px}.alya-gallery-caption{font-size:9px}.alya-lightbox-arrow{width:48px;height:48px}.alya-lightbox-prev{left:8px}.alya-lightbox-next{right:8px}.alya-lightbox-close{right:12px;top:12px;width:46px;height:46px}.alya-gallery-lightbox{padding:12px}.alya-gallery-lightbox img{max-width:96vw;max-height:86vh}}
      `}</style>
    </div>
  );
}
