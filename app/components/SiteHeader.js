  ...
  return <>
    ...
    <header>
      ...
      <div className="main-header">
        ...
        <nav><Link href="/collections/all">Tüm Ürünler</Link><Link href="/collections/kurutmalıklar">Kurutmalıklar <ChevronDown size={13}/></Link><Link href="/collections/ütü%20masaları">Ütü Masaları <ChevronDown size={13}/></Link></nav>
        <div className="actions"><Link href="/collections/all" aria-label="Ürün ara" className="icon-link"><Search size={21}/></Link><Link href="/account" aria-label="Hesabım" className="icon-link"><UserRound size={21}/></Link><Link href="/wishlist" aria-label="Favoriler" className="icon-link"><Heart size={21}/><b>{wishlistCount}</b></Link><Link href="/cart" aria-label="Sepet" className="icon-link cart"><ShoppingBag size={21}/><b>{count}</b></Link></div>
      </div>
    </header>
