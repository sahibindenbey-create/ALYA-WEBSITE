  ...
  return (
    <main className="alya-product-page">
      ...
      <style jsx>{`
        ...
        .alya-product-breadcrumbs{display:flex;gap:9px;align-items:center;color:#777;font-size:11px;margin-bottom:42px}.alya-product-breadcrumbs strong{color:#171717;font-weight:500}.alya-product-main{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(380px,.92fr);gap:7%;align-items:start}.alya-product-media{min-width:0}.alya-product-image{position:relative;background:#f2f0ec;aspect-ratio:1/1.05;display:grid;place-items:center;overflow:hidden}.alya-product-image img{width:100%;height:100%;object-fit:contain;display:block}.alya-code-badge{position:absolute;left:18px;top:18px;background:#fff;padding:8px 10px;font-size:9px;letter-spacing:1px;font-weight:700}.alya-image-note{font-size:10px;color:#888;margin:10px 0}.alya-image-fallback{display:grid;place-items:center;text-align:center;color:#777}.alya-image-fallback span{font-size:30px;font-weight:800;letter-spacing:-2px}.alya-image-fallback small{margin-top:8px;font-size:11px}.alya-gallery-thumbnails{display:grid;grid-template-columns:repeat(auto-fill,minmax(76px,1fr));gap:8px;margin-top:10px}.alya-gallery-thumb{border:1px solid #ddd;background:#f2f0ec;padding:0;aspect-ratio:1;overflow:hidden;cursor:pointer}.alya-gallery-thumb.is-active{border:2px solid #f58a1f}.alya-gallery-thumb img{width:100%;height:100%;object-fit:contain;display:block}.alya-product-info{padding:12px 0}.alya-eyebrow{font-size:10px;letter-spacing:1.7px;font-weight:700;color:#777}.alya-product-info h1{font-size:50px;line-height:1.02;font-weight:500;letter-spacing:-2px;margin:13px 0 7px}.alya-product-code{font-size:11px;color:#888;margin:0}.alya-price{font-size:21px;margin:24px 0}.alya-description{max-width:590px;color:#555;font-size:13px;line-height:1.8;margin-bottom:26px}.alya-feature-list{border-top:1px solid #ddd;border-bottom:1px solid #ddd;padding:7px 0;margin:0 0 25px}.alya-feature-list div{display:flex;align-items:center;gap:9px;padding:9px 0;font-size:12px}.alya-feature-list svg{color:#f58a1f;flex:none}.alya-detail-note{font-size:11px;line-height:1.6;color:#666;background:#f6f4f0;padding:15px;margin-bottom:14px}.alya-primary-button{width:100%;background:#f58a1f;color:#fff;padding:17px 22px;display:flex;justify-content:center;align-items:center;gap:9px;font-size:12px}.alya-wish-button{width:100%;margin-top:9px;border:1px solid #171717;padding:15px;font-size:12px;display:flex;justify-content:center;align-items:center;gap:8px}.alya-service-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:25px}.alya-service-grid div{border-top:1px solid #ddd;padding-top:14px;display:flex;gap:9px;color:#777;font-size:10px;line-height:1.5}.alya-service-grid svg{flex:none;color:#171717}.alya-service-grid b{display:block;color:#171717;font-size:10px;margin-bottom:2px}.alya-spec-section{border-top:1px solid #ddd;margin-top:85px;padding-top:34px;display:grid;grid-template-columns:.7fr 1.3fr;gap:6%}.alya-spec-section h2,.alya-related h2{font-size:32px;font-weight:500;letter-spacing:-1px;margin:9px 0}.alya-spec-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;background:#ddd}.alya-spec-card{background:#fff;padding:18px 20px;display:flex;justify-content:space-between;gap:20px}.alya-spec-card span{text-transform:capitalize;color:#777;font-size:11px}.alya-spec-card strong{font-size:12px;font-weight:600;text-align:right}.alya-related{margin-top:95px}.alya-section-heading{display:flex;justify-content:space-between;align-items:end;margin-bottom:28px}.alya-section-heading>a{display:flex;gap:7px;align-items:center;border-bottom:1px solid #171717;padding-bottom:4px;font-size:11px}.alya-related-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:17px}.alya-related-image{aspect-ratio:1/1.12;background:#f2f0ec;overflow:hidden}.alya-related-image img{width:100%;height:100%;object-fit:contain;display:block}.alya-related-card h3{font-size:13px;font-weight:500;margin:13px 0 7px}.alya-related-card p{font-size:12px;margin:0}
        @media(max-width:900px){.alya-product-main{grid-template-columns:1fr;gap:25px}.alya-product-info{max-width:760px}.alya-spec-section{grid-template-columns:1fr;gap:20px}.alya-related-grid{grid-template-columns:repeat(3,1fr)}}
        @media(max-width:650px){.alya-product-page{padding:25px 18px 70px}.alya-product-breadcrumbs{flex-wrap:wrap;margin-bottom:25px}.alya-product-info h1{font-size:38px}.alya-service-grid{grid-template-columns:1fr}.alya-spec-grid{grid-template-columns:1fr}.alya-related-grid{grid-template-columns:repeat(2,1fr)}.alya-spec-section{margin-top:55px}.alya-related{margin-top:65px}}
      `}</style>
    </main>
  );
}
