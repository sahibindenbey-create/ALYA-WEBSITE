    ...
    <section className="alya-product-main">
      ...
      <div className="alya-product-info">
        ...
        <div className="alya-accordion">
          ...
          {openPanel==='shipping'&&<div className="alya-accordion-content"><p>Ürün stok durumuna göre hazırlanır ve güvenli şekilde sevk edilir. Teslimat ve iade koşulları sipariş aşamasında güncel bilgilerle gösterilir.</p></div>}
        </div>
