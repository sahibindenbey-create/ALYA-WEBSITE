      ...
      <section className="alya-product-main">
        <div className="alya-product-media">
          <div className="alya-product-image">
            {!imageFailed && p.image ? (
              <img src={p.image} alt={`${p.name} - ALYA HOMES`} onError={() => setImageFailed(true)} />
            ) : (
              <div className="alya-image-fallback"><span>ALYA HOMES</span><small>{p.name}</small></div>
            )}
            <span className="alya-code-badge">{p.code}</span>
          </div>
